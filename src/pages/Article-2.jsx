        ...
        <>
            ...
            <div class="article-hero">
                <picture >
                    ...
                    <img src="./img/article-hero-img.png" alt="slider-1" class="article-hero__img" />
                </picture>
            </div>
            ...
            <div class="article">
                <div class="article__back">
                    <img src="./img/back-arrow.svg" alt="" class="article__arrow" />
                    <span>Back</span>
                </div>
                <div class="article__time">10 May, 2020</div>
                <div class="article__title">How to save on buying a car? Why is it better to buy from us</div>
                <div class="article__heading1">Voluptate nulla amet ad commodo veniam consequat. </div>
                <div class="article__text">Id dolore mollit excepteur magna consectetur et dolore mollit qui quis do ea consequat tempor. Sunt eu excepteur cupidatat aliqua anim. Aliqua consectetur commodo magna ea proident aliquip. Minim ipsum irure ad irure sint cupidatat labore.
                ...
                <div class="article__double-imgs">
                    <picture >
                        <source type='image/webp' srcSet='./img/article-img-1-600.webp' media="(max-width: 600px)" />
                        <source type='image/webp' srcSet='./img/article-img-1-1200.webp' media="(max-width: 1200px)" />
                        <source type='image/webp' srcSet='./img/article-img-1.webp' />
                        <img src="./img/article-img-1.png" alt="slider-1" class="article__img" />
                    </picture>
                    <picture >
                        <source type='image/webp' srcSet='./img/article-img-2-600.webp' media="(max-width: 600px)" />
                        <source type='image/webp' srcSet='./img/article-img-2-1200.webp' media="(max-width: 1200px)" />
                        <source type='image/webp' srcSet='./img/article-img-2.webp' />
                        <img src="./img/article-img-2.png" alt="slider-1" class="article__img" />
                    </picture>
                </div>

                <div class="article__heading1">Voluptate nulla amet ad commodo veniam consequat. </div>
                <div class="article__text">Voluptate nulla amet ad commodo veniam consequat laborum tempor proident cupidatat aute nisi eiusmod laborum. Esse amet duis aliqua culpa consequat et. Laborum tempor commodo et exercitation consectetur aute laborum aliquip tempor nostrud nulla nisi labore. Tempor tempor laboris officia consectetur sint esse sit ad nostrud et deserunt laborum sint eu. Cillum laboris et sint reprehenderit deserunt.
                ...
                <picture >
                    <source type='image/webp' srcSet='./img/article-img-3-600.webp' media="(max-width: 600px)" />
                    <source type='image/webp' srcSet='./img/article-img-3-1200.webp' media="(max-width: 1200px)" />
                    <source type='image/webp' srcSet='./img/article-img-3.webp' />
                    <img src="./img/article-img-3.png" alt="slider-1" class="article__big-img" />
                </picture>
                ...
                <div class="article__heading2">Voluptate nulla amet ad commodo veniam consequat. </div>
                <div class="article__text">Voluptate nulla amet ad commodo veniam consequat laborum tempor proident cupidatat aute nisi eiusmod laborum. Esse amet duis aliqua culpa consequat et. Laborum tempor commodo et exercitation consectetur aute laborum aliquip tempor nostrud nulla nisi labore. </div>

                <div class="article__heading2">Voluptate nulla amet ad commodo veniam consequat. </div>
                <div class="article__text">Voluptate nulla amet ad commodo veniam consequat laborum tempor proident cupidatat aute nisi eiusmod laborum. Esse amet duis aliqua culpa consequat et. Laborum tempor commodo et exercitation consectetur aute laborum aliquip tempor nostrud nulla nisi labore. </div>

                <picture >
                    <source type='image/webp' srcSet='./img/article-img-4-600.webp' media="(max-width: 600px)" />
                    <source type='image/webp' srcSet='./img/article-img-4-1200.webp' media="(max-width: 1200px)" />
                    <source type='image/webp' srcSet='./img/article-img-4.webp' />
                    <img src="./img/article-img-4.png" alt="slider-1" class="article__very-big-img" />
                </picture>
                <div class="article__img-description">Voluptate nulla amet ad commodo veniam consequat laborum tempor proident cupidatat aute nisi eiusmod laborum.</div>
